...
const TOOL = {
  ...
  featured: false,
  riskLevel: 'low',
  relatedSlugs: ['uv-index-sun-safety', 'dri-calculator', 'water-intake-calculator', 'calorie-calculator'],
  seo: {
    metaTitle: 'Vitamin D & Sun Exposure Calculator',
    metaDescription: 'Estimate your vitamin D synthesis potential from sun, skin type, and diet. Educational guide with safe-sun reminders. This does NOT measure blood vitamin D — ask for a test if concerned.',
    canonical: '',
...
async function main() {
  ...
  console.log('\n✅ Vitamin D & Sun Exposure tool injected successfully!')
