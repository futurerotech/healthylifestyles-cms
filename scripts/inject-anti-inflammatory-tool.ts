...
const TOOL = {
  ...
  featured: false,
  riskLevel: 'low',
  relatedSlugs: ['mediterranean-diet-score', 'dash-score', 'recipe-nutrition', 'gut-health-score'],
  seo: {
    metaTitle: 'Anti-Inflammatory Diet Score — Food Frequency',
    metaDescription: 'Score your diet for anti-inflammatory foods (vegetables, fruit, fatty fish, olive oil, nuts) vs pro-inflammatory foods (processed meat, sugar, fried food). Free, educational.',
    canonical: '',
...
async function main() {
  ...
  console.log('\n✅ Anti-Inflammatory Diet Score tool injected successfully!')
