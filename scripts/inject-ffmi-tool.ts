...
const TOOL = {
  ...
  featured: false,
  riskLevel: 'low',
  relatedSlugs: ['body-fat-calculator', 'lean-body-mass-calculator', 'one-rep-max-calculator', 'strength-program-builder'],
  seo: {
    metaTitle: 'FFMI Calculator — Fat-Free Mass Index for Athletes',
    metaDescription: 'Calculate your Fat-Free Mass Index (FFMI) and height-normalized FFMI. A useful fitness metric for lifters and athletes — not a medical diagnosis.',
    canonical: '',
...
async function main() {
  ...
  console.log('\n✅ FFMI tool injected successfully!')
