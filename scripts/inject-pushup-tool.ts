...
const TOOL = {
  ...
  featured: false,
  riskLevel: 'low',
  relatedSlugs: ['one-rep-max-calculator', 'strength-program-builder', 'vo2-max-calculator', 'recovery-time-calculator'],
  seo: {
    metaTitle: 'Push-Up Test Calculator — Score by Age & Sex Norms',
    metaDescription: 'Score your push-up test against ACSM age and sex normative tables. See your percentile band, how to improve, and when to retest. Free fitness self-assessment.',
    canonical: '',
...
async function main() {
  ...
  console.log('\n✅ Push-Up Test tool injected successfully!')
